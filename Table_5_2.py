 ...
 QTableWidget{
  border: 0px solid rgb(0,0,0);     
    ...
    def __init__(self):
        ...
        # 기본 속성
        layout = QVBoxLayout(self)
        label = QLabel("8. 증기발생기 급수 주입을 실시하도록 주제어실에 지시한다.")
        label.setStyleSheet("font-size: 18pt;font-weight: bold")
        label.setContentsMargins(10, 10, 10, 20)

        label1 = QLabel("<p style=\"line-height:130%\">가. 주제어실에 다음과 같은 정보를 제공한다.<p>"
...
class ParaTable(QTableWidget):
    def __init__(self, parent):
        ...
        self.setItem(2, 0, QTableWidgetItem("급수주입펌프"))
        self.setItem(3, 0, QTableWidgetItem("급수주입유로"))
        self.setItem(4, 0, QTableWidgetItem("감압수단"))
        self.setItem(5, 0, QTableWidgetItem("급수주입경로"))
